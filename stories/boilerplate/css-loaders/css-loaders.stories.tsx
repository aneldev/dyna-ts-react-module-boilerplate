...
export const CSSLoaders = () => (
  <div style={{backgroundColor: "white"}}>
    ...
    <h3 className="intro-css-loaders__label--css">CSS loader, should be blue</h3>
    <h3 className="intro-css-loaders__label--less">LESS loader, should be purple</h3>
    <h3 className={lessStyles.label}>LESS module loader, should be violet</h3>
